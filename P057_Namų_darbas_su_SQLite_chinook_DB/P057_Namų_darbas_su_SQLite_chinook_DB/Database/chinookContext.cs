...
namespace P057_Namų_darbas_su_SQLite_chinook_DB.Database
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlite("DataSource=C:\\Project\\CA Mokymai\\P057_Namų_darbas_su_SQLite_chinook_DB\\P057_Namų_darbas_su_SQLite_chinook_DB\\chinook.db");
            }
        }
