...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221207164618_addedLocalUserTables")]
    partial class addedLocalUserTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 837, DateTimeKind.Local).AddTicks(9958),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 837, DateTimeKind.Local).AddTicks(9996),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 18, 837, DateTimeKind.Local).AddTicks(9999),
                            ImagePath = "gg",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
