...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221124162819_Initial")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 18, 28, 19, 490, DateTimeKind.Local).AddTicks(1199),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 18, 28, 19, 490, DateTimeKind.Local).AddTicks(1233),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 18, 28, 19, 490, DateTimeKind.Local).AddTicks(1235),
                            ImagePath = "gg",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food"
