...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221130182515_intitialMigration")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 30, 20, 25, 15, 808, DateTimeKind.Local).AddTicks(1166),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 30, 20, 25, 15, 808, DateTimeKind.Local).AddTicks(1202),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 30, 20, 25, 15, 808, DateTimeKind.Local).AddTicks(1204),
                            ImagePath = "gg",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
