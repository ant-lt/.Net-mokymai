...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221208172228_update_passwordsnd_role")]
    partial class updatepasswordsndrole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 28, 738, DateTimeKind.Local).AddTicks(3474),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 28, 738, DateTimeKind.Local).AddTicks(3507),
                            ImagePath = "gg",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 28, 738, DateTimeKind.Local).AddTicks(3509),
                            ImagePath = "gg",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
